...
function genesis_404() {
	...
	$genesis_404_content = sprintf(
		...
		__( 'Sorry! The page you are looking for no longer exists, or has moved. Perhaps you can go to the <a href="%s">homepage</a> and see if you can find what you are looking for.', 'genesis' ),
